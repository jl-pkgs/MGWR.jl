...
function gwr_mixed(x1::Matrix{Float64}, x2::Matrix{Float64}, y::Vector{Float64},
  dMat::Matrix{Float64}, dMat_rp::Matrix{Float64},
  bw::Float64, kernel::Int, adaptive::Bool=false)
  ...
  model2 = gwr_q(x3, y2, dMat, 100000.0, BOXCAR, true)  # Fit global
  ...
  model2 = gwr_q(x3, y2, dMat_rp, 100000.0, BOXCAR, true)  # Final global fit
